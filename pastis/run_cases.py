...
if __name__ == '__main__':
    ...
    result_dir_medium = os.path.join(dir_medium, run_choice, 'results')
    matrix_dir_medium = os.path.join(dir_medium, run_choice, 'matrix_numerical')
    ...
    result_dir_large = os.path.join(dir_large, run_choice, 'results')
    matrix_dir_large = os.path.join(dir_large, run_choice, 'matrix_numerical')
